...
This app was created to eliminate dependence on cued active recall spaced repetition programs, such as flashcards, and utilize free active recall speced repetition-based programs (geared towards professional exams like the Medical College Admissions Test).
